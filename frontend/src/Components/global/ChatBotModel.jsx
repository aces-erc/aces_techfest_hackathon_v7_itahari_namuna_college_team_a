  ...
  return (
    <div className=" flex items-center justify-center ">
      <div className="relative w-full flex flex-col h-full ">
        {/* Messages */}
        <div className="p-2 pb-[-1rem] flex flex-col gap-2 overflow-y-scroll w-full h-[calc(100vh-7rem)] relative " >
          {/* Chat Messages */}
          ...
          <div className=" dark:border-neutral-700 sticky bottom-[-1rem] left-0 w-full">
            <div className="relative ">
              <textarea
                value={prompt}
                onChange={(e) => setPrompt(e.target.value)}
                className="w-full p-4 pr-12 rounded-lg resize-none focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 border-neutral-700 text-white"
