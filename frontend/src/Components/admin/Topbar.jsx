...
const Topbar = () => {
    ...
    return (
        <header className='sticky top-0 z-999 flex w-full bg-white drop-shadow-1 h-20 shadow-md justify-between' >
            <div className="relative my-grid ml-8">
                <input className='border-2 p-1 rounded-md' placeholder='Type to search...' type="search" name="" id="" />
            ...
            <div className="flex justify-center items-center gap-4 mr-8">
                ...
                <div className="flex justify-center items-center gap-1">
                    <span className='text-primary font-bold'>Jhon doe {currentUser?.name}</span>
