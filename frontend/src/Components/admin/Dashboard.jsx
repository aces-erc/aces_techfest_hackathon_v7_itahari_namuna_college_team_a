            ...
            <div className="flex gap-16">
                <div className="w-1/3 h-48 shadow-lg bg-white p-8 flex flex-col justify-center items-center gap-2">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <span className='text-2xl font-bold text-primary'>{data?.total_users}</span>
                ...
                <div className="w-1/3 h-48 shadow-lg bg-white p-8 flex flex-col justify-center items-center gap-2">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <span className='text-2xl font-bold text-primary'>{data?.total_products}</span>
                ...
                <div className="w-1/3 h-48 shadow-lg bg-white p-8 flex flex-col justify-center items-center gap-2">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <span className='text-2xl font-bold text-primary'>{data?.total_sales}</span>
