    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-white via-green-50 to-blue-50">
            ...
            <div className="relative z-10">
                <nav className="flex justify-between items-center p-6 backdrop-blur-sm bg-white/30">
                    <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-blue-600">
                        AroHealth
                    </h1>
                    <div className="flex gap-4">
                        <button className="px-6 py-2 text-green-600 hover:text-green-700 transition-colors">
                            About
                        </button>
                        <button className="px-6 py-2 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-0.5">
                            Login
                        </button>
                    </div>
                </nav>
                ...
                <main className="container mx-auto px-4 py-12">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            ...
                            <div className="flex gap-4">
                                <button className="px-8 py-3 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-0.5">
                                    Get Started
                                </button>
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-green-200 to-blue-200 rounded-full filter blur-3xl opacity-30 animate-pulse"></div>
                            <img
